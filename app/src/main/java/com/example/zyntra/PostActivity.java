...
public class PostActivity extends AppCompatActivity {
                ...
                .addOnSuccessListener(snapshot -> {
                    if (snapshot.exists()) {
                        ...
                        db.collection("Posts")
                                ...
                                .addOnSuccessListener(unused -> {btnLike.setImageResource(R.drawable.icon_liked);
                                });
                    }
                });
    }
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            String userImg = snapshot.getString("userImage");
    ...
    private void postComment() {
        ...
        String userId = user.getUid();db.collection("users").document(userId)
                .get()
